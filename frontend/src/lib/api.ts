...
const MOCK_POINTS: Record<number, BacnetPoint[]> = {
	100: [
		{ objectType: 'analog-input', objectInstance: 0, objectName: 'Supply Air Temp', description: 'AHU-1 supply air temperature sensor', presentValue: 55.2, units: '°F', writable: false, statusFlags: [] },
		{ objectType: 'analog-input', objectInstance: 1, objectName: 'Return Air Temp', description: 'AHU-1 return air temperature sensor', presentValue: 72.8, units: '°F', writable: false, statusFlags: [] },
		{ objectType: 'analog-input', objectInstance: 2, objectName: 'Mixed Air Temp', description: 'Mixed air temperature', presentValue: 63.1, units: '°F', writable: false, statusFlags: [] },
		{ objectType: 'analog-input', objectInstance: 3, objectName: 'Outside Air Temp', description: 'Outside air temperature from OAT sensor', presentValue: 42.5, units: '°F', writable: false, statusFlags: [] },
		...
		{ objectType: 'analog-value', objectInstance: 0, objectName: 'SAT Setpoint', description: 'Supply air temp setpoint', presentValue: 55.0, units: '°F', writable: true, statusFlags: [] },
	...
	101: [
		{ objectType: 'analog-input', objectInstance: 0, objectName: 'Zone Temp', description: 'VAV zone temperature', presentValue: 73.4, units: '°F', writable: false, statusFlags: [] },
		...
		{ objectType: 'analog-value', objectInstance: 0, objectName: 'Zone Temp SP', description: 'Zone temperature setpoint', presentValue: 72.0, units: '°F', writable: true, statusFlags: [] },
	...
	102: [
		{ objectType: 'analog-input', objectInstance: 0, objectName: 'Zone Temp', description: 'VAV zone temperature', presentValue: 71.8, units: '°F', writable: false, statusFlags: [] },
	...
	200: [
		{ objectType: 'analog-input', objectInstance: 0, objectName: 'CHWS Temp', description: 'Chilled water supply temperature', presentValue: 44.2, units: '°F', writable: false, statusFlags: [] },
		{ objectType: 'analog-input', objectInstance: 1, objectName: 'CHWR Temp', description: 'Chilled water return temperature', presentValue: 56.1, units: '°F', writable: false, statusFlags: [] },
		{ objectType: 'analog-input', objectInstance: 2, objectName: 'CW Supply Temp', description: 'Condenser water supply', presentValue: 82.3, units: '°F', writable: false, statusFlags: [] },
		...
		{ objectType: 'analog-value', objectInstance: 0, objectName: 'CHWS SP', description: 'Chilled water setpoint', presentValue: 44.0, units: '°F', writable: true, statusFlags: [] },
	],
	201: [],
	300: [
